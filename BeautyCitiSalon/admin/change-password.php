...
$query=mysqli_query($con,"SELECT users_id FROM tbl_users WHERE users_id='$adminid' AND users_password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"UPDATE tbl_users SET userS_password='$newpassword' WHERE users_id='$adminid'");
...
<html>
<head>
<title>BeautiCiti Salon | Change Password</title>
...
<body class="cbp-spmenu-push">
  ...
  <?php
$adminid=$_SESSION['bpmsaid'];
$ret=mysqli_query($con,"SELECT * FROM tbl_users WHERE users_id='$adminid'");
$cnt=1;
