...
<html>
<head>
<title>BeautyCiti Salon || Accepted Booking</title>
				...
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<div class="row" style="background: #f2f2f2">
							<div class="col-md-6"><br><h4>Accepted List:</h4></div>
							<div class="col-md-6">
								<div class="row">
						...
						<table class="table table-bordered" id="example1"> 
							...
							if(isset($_GET['from'])){
								...
								if($user['type'] == 1){
									...
									$ret=mysqli_query($con,"SELECT * FROM tblbook tb
									INNER JOIN tbl_users tu ON tu.users_id=tb.tblbook_userid 
									WHERE tb.tblbook_status = 'Accepted' AND tb.tblbook_staffid = '$staff_id'
									GROUP BY tb.tblbook_bookingnumber
									ORDER BY tb.tblbook_id DESC");
							...
							<?php if($row['tblbook_status']==""){ ?>
                     		...
                     		<?php } else { ?>
                                ...
                                <td>
									...
									<a href="accepted-booking.php?paidid=<?php echo $row['tblbook_bookingnumber'];?>&userid=<?php echo $row['users_id'];?>" class="btn btn-success">Paid</a>
