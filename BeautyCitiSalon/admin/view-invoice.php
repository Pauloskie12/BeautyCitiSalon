...
<html>
<head>
<title>BeautyCiti Salon || View Invoice</title>
			...
			<div class="main-page">
				<div class="tables" id="exampl">
					...
					<?php
						...
						WHERE tb.tblbook_bookingnumber='$invid'
						...
						<table class="table table-bordered" width="100%" border="1"> 
							...
							<th colspan="6">Customer Details</th>	
							 ...
							 <tr> 
								...
								<th>Booking Date</th> 
								<td colspan="3"><?php echo $row['tblbook_bookingdate']?></td> 
							</tr> 
							<?php }?>
						</table>
						<table class="table table-bordered" width="100%" border="1"> 
								...
								<tr>
									...
									<td><?php echo $subtotal=$row['subcategory_price']?></td>
									</tr>
									<?php 
									$cnt=$cnt+1;
									$gtotal+=$subtotal;
